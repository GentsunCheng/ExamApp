...
_DICT = {
    'zh-Hans': {
        ...
        'viewer.pymupdf_not_installed': '未安装 PyMuPDF，无法渲染 PDF 文件',
        'viewer.python_docx_not_installed': '未安装 python-docx，无法渲染 Word 文件',
        'viewer.openpyxl_not_installed': '未安装 openpyxl，无法渲染 Excel 文件',
        'viewer.markdown_not_installed': '未安装 markdown 库，无法渲染 Markdown 文件',
        'viewer.pptx_not_installed': '未安装 python-pptx，无法渲染 PPTX 文件',
        'viewer.multimedia_not_installed': 'Qt Multimedia 不可用，无法播放音视频',
    ...
    'en': {
        ...
        'viewer.pymupdf_not_installed': 'PyMuPDF not installed, cannot render PDF files',
        'viewer.python_docx_not_installed': 'python-docx not installed, cannot render Word files',
        'viewer.openpyxl_not_installed': 'openpyxl not installed, cannot render Excel files',
        'viewer.markdown_not_installed': 'markdown library not installed, cannot render Markdown files',
        'viewer.pptx_not_installed': 'python-pptx not installed, cannot render PPTX files',
        'viewer.multimedia_not_installed': 'Qt Multimedia not available, cannot play media',
