...
_DICT = {
    'zh-Hans': {
        ...
        'admin.import.success': '导入成功：单选{single} 多选{multiple} 判断{truefalse} 填空{fill}；必考{mandatory} 随机{random}{extra}',
    ...
    'en': {
        ...
        'admin.import.success': 'Imported: Single {single} Multiple {multiple} True/False {truefalse} Fill {fill}; Mandatory {mandatory} Random {random}{extra}',
