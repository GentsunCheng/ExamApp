...
_DICT = {
    'zh-Hans': {
        ...
        'viewer.open_external': '用外部程序打开',
        'viewer.save_as': '另存为...',
        'viewer.save_as_success': '文件已保存到：{path}',
        'viewer.render_error': '文件渲染失败：{error}',
        'viewer.image_load_failed': '图片加载失败',
        'viewer.pptx_slide': '第 {num} 页幻灯片',
        'viewer.media_play': '播放',
        'viewer.media_pause': '暂停',
        'viewer.audio_playing': '正在播放：{name}',
        'viewer.unsupported_format': '不支持的文件格式：{ext}',
        'viewer.xlsx_truncated': '（仅显示前 {shown} 行，共 {total} 行）',
        'login.title': '登录',
        ...
        'admin.export.exam': '导出',
        'admin.export.exam.title': '导出试卷题目',
        'admin.export.exam.done': '题目已导出',
        ...
        'admin.import.success': '导入成功：单选{single} 多选{multiple} 判断{truefalse} 填空{fill} 简答{essay}；必考{mandatory} 随机{random}{extra}',
        ...
        'admin.questions.back': '返回',
        'admin.questions.mandatory_group': '必考题',
        'admin.questions.random_group': '随机题库',
        'admin.questions.random_pick': '随机抽取数量',
        'admin.questions.add_btn': '添加题目',
        'admin.questions.save_btn': '保存',
        'admin.questions.delete_btn': '删除',
        'admin.questions.type': '类型',
        'admin.questions.score': '分数',
        'admin.questions.pool': '所属题库',
        'admin.questions.pool.mandatory': '必考题',
        'admin.questions.pool.random': '随机题库',
        'admin.questions.content': '题目内容',
        'admin.questions.options': '选项',
        'admin.questions.correct': '正确答案',
        'admin.questions.correct_none': '无（简答题人工阅卷）',
        'admin.questions.fill_hint': '多个答案请用 / 分隔',
        'admin.questions.delete_confirm': '确定要删除该题目吗？',
        'admin.questions.deleted': '题目已删除',
        'admin.questions.saved': '题目已保存',
        'admin.questions.select_first': '请先选择一道题目',
        'admin.questions.text_required': '题目内容不能为空',
        'admin.questions.invalid_correct': '正确答案无效',
        'admin.questions.no_options': '请至少填写一个选项',
        'admin.questions.empty': '暂无题目',
        'admin.questions.view_hint': '双击左侧题目查看详情，点击"编辑"可修改',
        'admin.questions.new_question': '（新题目，保存后加入题库）',
        'admin.questions.pictures': '图片',
        'admin.questions.open_hint': '双击试题行可管理该试题的题目',
        ...
        'knowledge.tab': '知识库',
        'knowledge.share': '分享文件',
        'knowledge.refresh': '刷新',
        'knowledge.filename': '文件名',
        'knowledge.uploader': '上传者',
        'knowledge.category': '分类',
        'knowledge.keywords': '关键词',
        'knowledge.uploaded_at': '上传时间',
        'knowledge.filter_keyword': '搜索关键词',
        'knowledge.filter_category': '筛选分类',
        'knowledge.filter_uploader': '筛选上传者',
        'knowledge.all': '全部',
        'knowledge.input_category': '输入或选择分类',
        'knowledge.input_keywords': '输入关键词（逗号分隔）',
        'knowledge.upload_title': '上传知识库文件',
        'knowledge.new_category': '新建分类',
        'knowledge.category_ph': '选择或输入新分类',
        'knowledge.file_shared': '文件已分享到知识库',
        'knowledge.no_files': '暂无知识库文件',
        'knowledge.open_file': '打开文件',
        'knowledge.search': '搜索',
        'knowledge.delete_confirm': '确定要删除该文件吗？',
        'knowledge.file_deleted': '文件已删除',
        'knowledge.no_permission': '没有删除权限',
        ...
        'exam.type.fill': '填空题',
        'exam.type.essay': '简答题',
        'exam.fill_answer': '请填写答案',
        'exam.fill_placeholder': '在此输入答案...',
        'exam.fill_correct_answer': '正确答案',
        'exam.essay_answer': '请作答',
        'exam.essay_placeholder': '在此输入你的答案...',
        'exam.pending_review': '待批阅',
        'exam.reviewed': '已批阅',
        'exam.review_score': '批阅得分',
        'exam.review_comment': '批阅评语',
        'exam.true': '正确',
        'exam.false': '错误',
        ...
        'admin.review.title': '简答题批阅',
        'admin.review.save': '保存批阅',
        'admin.review.saved': '批阅已保存',
        'admin.review.recalculated': '分数已重新计算',
        'admin.review.empty': '暂无待批阅题目',
    ...
    'en': {
        ...
        'viewer.open_external': 'Open with External App',
        'viewer.save_as': 'Save As...',
        'viewer.save_as_success': 'File saved to: {path}',
        'viewer.render_error': 'Render failed: {error}',
        'viewer.image_load_failed': 'Failed to load image',
        'viewer.pptx_slide': 'Slide {num}',
        'viewer.media_play': 'Play',
        'viewer.media_pause': 'Pause',
        'viewer.audio_playing': 'Now Playing: {name}',
        'viewer.unsupported_format': 'Unsupported file format: {ext}',
        'viewer.xlsx_truncated': '(Showing first {shown} rows, {total} rows total)',
        'login.title': 'Login',
        ...
        'error.old_password_wrong': 'Incorrect old password',
        'info.settings_saved': 'Settings saved successfully',
        'exams.id': 'ID',
        'exams.title': 'Title',
        ...
        'info.user_updated': 'User info updated',
        ...
        'admin.export.exam': 'Export',
        'admin.export.exam.title': 'Export Exam Questions',
        'admin.export.exam.done': 'Questions exported',
        ...
        'admin.import.success': 'Imported: Single {single} Multiple {multiple} True/False {truefalse} Fill {fill} Essay {essay}; Mandatory {mandatory} Random {random}{extra}',
        ...
        'admin.questions.back': 'Back',
        'admin.questions.mandatory_group': 'Mandatory',
        'admin.questions.random_group': 'Random Pool',
        'admin.questions.random_pick': 'Random pick count',
        'admin.questions.add_btn': 'Add Question',
        'admin.questions.save_btn': 'Save',
        'admin.questions.delete_btn': 'Delete',
        'admin.questions.type': 'Type',
        'admin.questions.score': 'Score',
        'admin.questions.pool': 'Pool',
        'admin.questions.pool.mandatory': 'Mandatory',
        'admin.questions.pool.random': 'Random',
        'admin.questions.content': 'Question Content',
        'admin.questions.options': 'Options',
        'admin.questions.correct': 'Correct Answer',
        'admin.questions.correct_none': 'None (manual review)',
        'admin.questions.fill_hint': 'Separate multiple answers with /',
        'admin.questions.delete_confirm': 'Delete this question?',
        'admin.questions.deleted': 'Question deleted',
        'admin.questions.saved': 'Question saved',
        'admin.questions.select_first': 'Please select a question first',
        'admin.questions.text_required': 'Question content is required',
        'admin.questions.invalid_correct': 'Invalid correct answer',
        'admin.questions.no_options': 'Please fill in at least one option',
        'admin.questions.empty': 'No questions',
        'admin.questions.view_hint': 'Double-click a question on the left to view; click "Edit" to modify',
        'admin.questions.new_question': '(New question, added to the pool after saving)',
        'admin.questions.pictures': 'Images',
        'admin.questions.open_hint': 'Double-click an exam row to manage its questions',
...
'knowledge.share': 'Share File',
'knowledge.refresh': 'Refresh',
'knowledge.filename': 'Filename',
'knowledge.uploader': 'Uploader',
'knowledge.category': 'Category',
'knowledge.keywords': 'Keywords',
'knowledge.uploaded_at': 'Uploaded At',
'knowledge.filter_keyword': 'Search Keywords',
'knowledge.filter_category': 'Filter by Category',
'knowledge.filter_uploader': 'Filter by Uploader',
'knowledge.all': 'All',
'knowledge.input_category': 'Enter or select category',
'knowledge.input_keywords': 'Enter keywords (comma separated)',
'knowledge.upload_title': 'Upload to Knowledge Base',
'knowledge.new_category': 'New Category',
'knowledge.category_ph': 'Select or enter new category',
'knowledge.file_shared': 'File shared to knowledge base',
'knowledge.no_files': 'No files in knowledge base',
'knowledge.open_file': 'Open File',
'knowledge.search': 'Search',
'knowledge.delete_confirm': 'Are you sure to delete this file?',
'knowledge.file_deleted': 'File deleted',
'knowledge.no_permission': 'No permission to delete',
'admin.targets.set_admin': 'Set as admin device',
        ...
        'exam.type.fill': 'Fill-in-the-blank',
        'exam.type.essay': 'Essay',
        'exam.fill_answer': 'Answer',
        'exam.fill_placeholder': 'Type your answer here...',
        'exam.fill_correct_answer': 'Correct answer',
        'exam.essay_answer': 'Your Answer',
        'exam.essay_placeholder': 'Type your answer here...',
        'exam.pending_review': 'Pending Review',
        'exam.reviewed': 'Reviewed',
        'exam.review_score': 'Review Score',
        'exam.review_comment': 'Review Comment',
        'exam.true': 'True',
        'exam.false': 'False',
        ...
        'admin.review.title': 'Essay Review',
        'admin.review.save': 'Save Review',
        'admin.review.saved': 'Review saved',
        'admin.review.recalculated': 'Score recalculated',
        'admin.review.empty': 'No pending reviews'
    }
}
